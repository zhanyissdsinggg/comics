...
@Module({
  ...
  providers: [AdminMarketingService, AdminMembersService, PrismaService, AdminLogService, ConfigService],
  exports: [AdminMarketingService, AdminMembersService, AdminLogService, ConfigService],
})
