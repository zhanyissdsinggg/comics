...
import type {
  ...
  SaveRecommendationAnalyticsBody,
...
export class AdminRecommendationController {
  ...
  async getSlots(@Query() filters: RecommendationPaginationFilters) {
  ...
  async createSlot(@Body() body: CreateRecommendationSlotInput) {
  ...
  async updateSlot(@Param('id') id: string, @Body() body: UpdateRecommendationSlotInput) {
  ...
  async getRankings(@Query() filters: RecommendationPaginationFilters) {
  ...
  async createRanking(@Body() body: CreateRankingConfigInput) {
  ...
  async updateRanking(@Param('id') id: string, @Body() body: UpdateRankingConfigInput) {
  ...
  async getAnalytics(@Query() filters: RecommendationAnalyticsFilters) {
  ...
  async saveAnalytics(@Body() body: SaveRecommendationAnalyticsBody) {
  ...
  async getSlotPerformance(@Param('id') id: string, @Query() filters: RecommendationPerformanceFilters) {
  ...
  async getRankingPerformance(
    ...
    @Query() filters: RecommendationPerformanceFilters,
  ) {
  ...
  async getPopularSeries(@Query() filters: PopularSeriesFilters) {
