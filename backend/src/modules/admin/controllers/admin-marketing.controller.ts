...
export class AdminMarketingController {
  ...
  async getCampaigns(@Query() filters: MarketingCampaignFilters) {
  ...
  async createCampaign(@Body() body: CreateMarketingCampaignInput) {
  ...
  async updateCampaign(@Param('id') id: string, @Body() body: UpdateMarketingCampaignInput) {
  ...
  async getCampaignAnalytics(@Param('id') id: string, @Query() filters: MarketingAnalyticsFilters) {
  ...
  async saveMarketingAnalytics(@Param('id') id: string, @Body() body: SaveMarketingAnalyticsBody) {
  ...
  async getTargetUsers(@Param('id') id: string, @Query() filters: MarketingTargetFilters) {
    return this.marketingService.getTargetUsers(id, filters);
  }

  @Post('campaigns/:id/targets')
  @AdminAudit('create', 'marketing_targets')
  async addTargetUsers(@Param('id') id: string, @Body() body: AddMarketingTargetUsersInput) {
  ...
  async updateTargetUserStatus(
    ...
    @Body() body: UpdateMarketingTargetStatusInput,
  ) {
  ...
  async updateCampaignBudget(@Param('id') id: string, @Body() body: UpdateMarketingBudgetInput) {
  ...
  async getMarketingStats(@Query() filters: MarketingStatsFilters) {
  ...
  @AdminAudit('read', 'marketing_stats')
  async getCampaignsBySegment(@Query() filters: MarketingStatsFilters) {
  ...
  @Get('stats/by-type')
  @AdminAudit('read', 'marketing_stats')
  async getCampaignsByType(@Query() filters: MarketingStatsFilters) {
