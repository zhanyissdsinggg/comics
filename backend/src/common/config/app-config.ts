...
const appConfigSchema = z
  .object({
    ...
    INTERACTIVE_AI_ENABLED: z.string().optional().default("1"),
    OPENAI_API_KEY: z.string().optional().default(""),
    OPENAI_BASE_URL: z.string().optional().default("https://api.openai.com/v1"),
    OPENAI_MODEL: z.string().optional().default("gpt-4o-mini"),
    INTERACTIVE_AI_TIMEOUT_MS: z.coerce.number().int().min(1000).max(60000).default(12000),
  ...
  .transform((env) => {
    ...
    return {
      ...
      ai: {
        enabled: normalizeBoolean(env.INTERACTIVE_AI_ENABLED, true),
        openaiApiKey: normalizeOptional(env.OPENAI_API_KEY),
        openaiBaseUrl: normalizeOptional(env.OPENAI_BASE_URL) || "https://api.openai.com/v1",
        openaiModel: normalizeOptional(env.OPENAI_MODEL) || "gpt-4o-mini",
        timeoutMs: env.INTERACTIVE_AI_TIMEOUT_MS,
      },
      billing: {
