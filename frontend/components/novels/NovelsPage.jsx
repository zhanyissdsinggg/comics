  ...
  useEffect(() => {
    async function loadNovels() {
      try {
        ...
        // 老王注释：只显示小说类型
        const novels = (data.series || []).filter((s) => s.type === "novel");
        setSeries(novels);
      } catch (error) {
    ...
    <div className="min-h-screen bg-neutral-950">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 rounded-3xl bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-rose-500/10 p-8 border border-purple-500/20">
          ...
          <p className="text-neutral-300">Discover amazing novels and web novels from talented authors</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-neutral-400 text-lg mb-2">No novels found</p>
            ...
            <button
              ...
              className="rounded-2xl bg-purple-500 px-6 py-3 text-white hover:bg-purple-600 transition-colors"
            >
              Reset Filters
            </button>
          </div>
