    ...
    return (
      <span
        className={cn(
          ...
          active
            ? isLight
              ? "border-[rgba(47,107,255,0.18)] bg-[rgba(47,107,255,0.08)] text-slate-950"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? isLight
            ? "border-[rgba(47,107,255,0.18)] bg-[rgba(47,107,255,0.08)] text-slate-950 shadow-[0_12px_26px_rgba(47,107,255,0.08)]"
