...
function ToastItem({ toast, onClose }) {
  ...
  const styles = {
    success: {
      panel:
        "border-[rgba(16,124,92,0.12)] bg-white dark:border-[rgba(77,212,176,0.18)] dark:bg-[linear-gradient(180deg,rgba(18,27,29,0.96),rgba(15,23,25,0.94))]",
      iconWrap:
    ...
    error: {
      panel:
        "border-[rgba(255,59,48,0.12)] bg-white dark:border-[rgba(255,137,124,0.2)] dark:bg-[linear-gradient(180deg,rgba(29,24,23,0.96),rgba(23,19,18,0.94))]",
      iconWrap:
    ...
    warning: {
      panel:
        "border-[rgba(176,95,0,0.12)] bg-white dark:border-[rgba(242,184,75,0.22)] dark:bg-[linear-gradient(180deg,rgba(31,27,21,0.96),rgba(24,21,17,0.94))]",
      iconWrap:
    ...
    info: {
      panel:
        "border-[color:var(--gush-border)] bg-white dark:border-[color:var(--gush-border-strong)] dark:bg-[linear-gradient(180deg,rgba(20,27,37,0.96),rgba(17,24,33,0.94))]",
      iconWrap:
        "border-[color:var(--gush-border)] bg-[#f8f8fa] text-slate-700 dark:border-[rgba(255,255,255,0.12)] dark:bg-white/[0.08]",
      icon: <Info size={18} />,
    },
  };
  ...
  return (
    <div
      ...
      className={`${style.panel} animate-in slide-in-from-right-3 fade-in-0 flex items-start gap-3 rounded-[24px] border px-4 py-3.5 text-[var(--gush-ink)] shadow-[0_16px_36px_rgba(15,23,42,0.08)] duration-300`}
    >
      <div
