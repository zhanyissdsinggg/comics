    ...
    <div className="mb-6 flex flex-col gap-3 sm:mb-8 md:flex-row md:items-end md:justify-between">
      ...
      {ctaLabel && typeof onCtaClick === "function" ? (
        <button
          ...
          onClick={onCtaClick}
          className={cn(
            "inline-flex items-center gap-2 rounded-full border-[3px] border-black bg-black px-5 py-3 text-xs font-black uppercase tracking-[0.08em] text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none sm:text-sm",
          )}
        >
          {ctaLabel}
...
function DiscoveryFallbackCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "group w-full rounded-[32px] border-[3px] border-black p-5 text-left shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none sm:p-8",
        accentClass,
      )}
    >
      <p className="text-[11px] font-black uppercase tracking-[0.18em] text-black/72 sm:text-sm">
