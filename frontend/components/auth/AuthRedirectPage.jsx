  ...
  return (
    <div className="gush-home-shell relative min-h-screen overflow-hidden">
      ...
      <main className="gush-page-main flex min-h-screen items-center justify-center">
        <div className="relative w-full max-w-md rounded-[32px] border border-[rgba(0,113,227,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(246,248,252,0.96))] px-8 py-8 text-center shadow-[0_26px_72px_rgba(15,23,42,0.08)]">
          <div className="mx-auto inline-flex rounded-full border border-[rgba(0,113,227,0.12)] bg-[rgba(0,113,227,0.06)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500">
            Redirecting
          </div>
