...
export function AdminListPagination({
  ...
  containerClassName = "flex flex-col gap-4 border-t border-[color:var(--gush-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.78),#f5f5f7)] px-5 py-4 text-sm text-slate-600 lg:flex-row lg:items-center lg:justify-between",
  ...
  const pageSummary = `第 ${page} 页，共 ${totalPages} 页`;

  return (
    <div className={containerClassName}>
      <div className="flex flex-wrap items-center gap-2">
        <span className="font-semibold text-slate-950">{pageSummary}</span>
        <span>，共</span>
