...
export default function BulkActionsToolbar({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2">
      <div className="min-w-[320px] rounded-[28px] border border-[color:var(--gush-border)] bg-white/98 px-5 py-4 shadow-[var(--gush-shadow-panel)] backdrop-blur-xl">
        {progressLabel ? (
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-slate-700">已选择 {selectedCount} 项</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={isProcessing}
              title="将已选作品转回草稿"
              className="inline-flex items-center gap-2 rounded-full border border-[color:var(--gush-border)] bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-[color:var(--gush-border-strong)] hover:bg-[color:var(--gush-page-bg-muted)] disabled:cursor-not-allowed disabled:opacity-50"
            >
              <EyeOff size={14} />
              <span>转为草稿</span>
            </button>
