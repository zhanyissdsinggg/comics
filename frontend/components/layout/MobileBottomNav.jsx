...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-[color:var(--gush-border)] bg-[rgba(255,255,255,0.96)] shadow-[0_-10px_24px_rgba(15,23,42,0.06)] backdrop-blur-xl dark:border-white/10 dark:bg-[rgba(15,15,18,0.86)] dark:shadow-[0_-18px_42px_rgba(0,0,0,0.24)] md:hidden"
    >
          ...
          return (
            <NavItem
              ...
              className={cn(
                ...
                isActive
                  ? "border border-[color:var(--gush-border)] bg-white text-[color:var(--gush-ink-strong)] shadow-[0_10px_24px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/[0.08] dark:text-white dark:shadow-[0_14px_30px_rgba(0,0,0,0.26)]"
                  : "text-[color:var(--gush-ink-faint)] hover:bg-black/[0.02] hover:text-[color:var(--gush-ink-soft)] dark:text-white/42 dark:hover:bg-white/[0.04] dark:hover:text-white/72",
              )}
            >
              <span
                className={cn(
