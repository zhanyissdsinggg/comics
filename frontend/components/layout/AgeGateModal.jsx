...
export default function AgeGateModal({ open, onClose, onConfirm, ageRuleKey, legalAge }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[90] flex min-h-screen items-center justify-center bg-[rgba(15,23,42,0.58)] px-4 py-6 backdrop-blur-md"
      onClick={onClose}
    >
      <div
        className="relative w-full max-w-xl overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(246,248,252,0.98))] p-6 shadow-[0_32px_120px_rgba(15,23,42,0.28)] sm:p-7"
      ...
      >
        ...
        <div className="relative">
          ...
          <h2 id="adult-gate-title" className="mt-3 font-display text-[2rem] font-semibold tracking-tight text-slate-950 sm:text-[2.35rem]">
            Adult Content Warning
          </h2>
          <p id="adult-gate-description" className="mt-4 text-sm leading-7 text-slate-600 sm:text-[15px]">
            This section contains material meant for adults only. Are you {currentAge} years of age or older?
          </p>

          <div className="mt-5 rounded-[24px] border border-[rgba(109,40,217,0.12)] bg-[rgba(109,40,217,0.06)] px-4 py-4">
