  ...
  loading: () => (
    <div className="min-h-screen bg-[#f4f6fb]">
      ...
      <div className="mx-auto max-w-6xl space-y-4 px-4 py-10">
        ...
        <Skeleton className="h-24 w-full rounded-2xl bg-white shadow-[0_18px_40px_rgba(15,23,42,0.06)]" />
        <Skeleton className="h-48 w-full rounded-2xl bg-white shadow-[0_18px_40px_rgba(15,23,42,0.06)]" />
      </div>
    </div>
  ),
});
